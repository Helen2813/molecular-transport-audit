...
$SCRIPT_VERSION = "04c-download-tcga-xena-pam50-v3"

$OutDir = "D:\paper4_tcbb_data\paper4_tcbb_tcga_pam50_xena_v3"
$RawFile = Join-Path $OutDir "BRCA_clinicalMatrix.txt"
$SafeFile = Join-Path $OutDir "tcga_pam50_safe_manifest_v3.tsv"
$AuditFile = Join-Path $OutDir "tcga_pam50_extraction_audit_v3.txt"
...
$tmpPy = Join-Path $env:TEMP "extract_tcga_pam50_xena_v3.py"
...
$tmpCheck = Join-Path $env:TEMP "check_tcga_pam50_text_v3.py"
...
Write-Host ""
Write-Host "===================================================================================================="
Write-Host "04c v3 TCGA PAM50 DOWNLOAD / SAFE EXTRACTION: PASS"
Write-Host "===================================================================================================="
Write-Host "Endpoint used:        $usedUrl"
