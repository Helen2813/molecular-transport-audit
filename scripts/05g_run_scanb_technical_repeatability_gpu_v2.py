...
SCRIPT_VERSION = "05g-run-scanb-technical-repeatability-gpu-v2-no-cli"
...
EXEC_CONTRACT = (
    ...
    / "scanb_technical_repeatability_execution_contract_v2.json"
)
PAIR_MANIFEST = (
    DATA_ROOT
...
OUT_DIR = DATA_ROOT / "paper4_tcbb_scanb_technical_repeatability_v2"
...
def main() -> None:
    ...
    result_path = OUT_DIR / "scanb_technical_repeatability_summary_v2.tsv"
    deg_path = OUT_DIR / "scanb_technical_repeatability_degenerate_genes_v2.tsv"
    ...
    master_path = OUT_DIR / "scanb_technical_repeatability_v2.json"
    ...
    print("\n" + "=" * 146)
    print("05g v2 SCAN-B TECHNICAL REPEATABILITY: COMPLETE")
    print("=" * 146)
    print(
