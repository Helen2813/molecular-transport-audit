...
SCRIPT_VERSION = "05j4c-audit-heldout-false-preservation-v2-no-cli"
...
OUT_DIR = DATA_ROOT / "paper4_tcbb_scale_invariant_heldout_calibration_audit_v2"
BY_PAIR = OUT_DIR / "heldout_false_preservation_by_pair_v2.tsv"
PAIRED = OUT_DIR / "heldout_false_preservation_paired_differences_v2.tsv"
METHOD_SUMMARY = OUT_DIR / "heldout_false_preservation_method_summary_v2.tsv"
PAIRED_SUMMARY = OUT_DIR / "heldout_false_preservation_paired_summary_v2.tsv"
SCHEMA_REPORT = OUT_DIR / "heldout_false_preservation_schema_binding_v2.json"
MASTER = OUT_DIR / "heldout_false_preservation_audit_v2.json"
...
def main() -> None:
    ...
    print("Implementation amendment: bind frozen `threshold_observed` schema and replay-check stored v3 held-out FPR.")
    print()
