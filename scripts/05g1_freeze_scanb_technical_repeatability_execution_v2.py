...
SCRIPT_VERSION = "05g1-freeze-scanb-technical-repeatability-execution-v2-no-cli"
...
OUT_DIR = (
    DATA_ROOT
    / "paper4_tcbb_scanb_technical_repeatability_execution_contract_v2"
)
...
def main() -> None:
    ...
    if pam.get("status") != "PAM50_SUBTYPE_AND_COMPOSITION_SENSITIVITY_COMPLETE":
    ...
    contract = {
        "contract_id": "paper4-tcbb-scanb-technical-repeatability-execution-v2",
        "script_version": SCRIPT_VERSION,
        "status": "FROZEN_BEFORE_SCANB_TECHNICAL_REPEATABILITY_RESULTS",
        "bugfix_provenance": {
            "supersedes_script": "05g1-freeze-scanb-technical-repeatability-execution-v1-no-cli",
            "reason": "v1 checked the completed 05f master against a misspelled status string that omitted AND",
            "actual_05f_status_required": "PAM50_SUBTYPE_AND_COMPOSITION_SENSITIVITY_COMPLETE",
    ...
    out = OUT_DIR / "scanb_technical_repeatability_execution_contract_v2.json"
    out.write_text(json.dumps(contract, indent=2), encoding="utf-8")

    print()
    print("=" * 146)
    print("05g1 v2 SCAN-B TECHNICAL-REPEATABILITY EXECUTION CONTRACT: PASS")
    print("=" * 146)
