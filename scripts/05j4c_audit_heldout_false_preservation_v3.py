...
SCRIPT_VERSION = "05j4c-audit-heldout-false-preservation-v3-no-cli"
...
OUT_DIR = DATA_ROOT / "paper4_tcbb_scale_invariant_heldout_calibration_audit_v3"
BY_PAIR = OUT_DIR / "heldout_false_preservation_by_pair_v3.tsv"
PAIRED = OUT_DIR / "heldout_false_preservation_paired_differences_v3.tsv"
METHOD_SUMMARY = OUT_DIR / "heldout_false_preservation_method_summary_v3.tsv"
PAIRED_SUMMARY = OUT_DIR / "heldout_false_preservation_paired_summary_v3.tsv"
SCHEMA_REPORT = OUT_DIR / "heldout_false_preservation_schema_binding_v3.json"
MASTER = OUT_DIR / "heldout_false_preservation_audit_v3.json"
...
def main() -> None:
    ...
    print("Implementation amendment: exact binding to observed v3 threshold/full-null schemas, including `valid_null_id`, with stored-v3 FPR replay guard.")
    print()
    ...
    for (target, program_id, method), g in grouped:
        ...
        # This is not inferred from the new result: the replay must reproduce the
        # hold-out FPR already stored by frozen 05j4 v3, or the script fails.
